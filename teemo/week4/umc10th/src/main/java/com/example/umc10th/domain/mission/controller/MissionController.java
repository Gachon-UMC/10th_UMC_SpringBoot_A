...
public class MissionController {
    ...
    public ApiResponse<MissionResDTO.MissionPreviewList> getOngoingMissions(
        ...
        return ApiResponse.of(GeneralSuccessCode.OK, missionService.getMyMissionList(request.getUserId(), false, PageRequest.of(request.getPage(), 10)));
    }
    ...
    public ApiResponse<MissionResDTO.MissionPreviewList> getMissionListByRegion(
        ...
        return ApiResponse.of(GeneralSuccessCode.OK, missionService.getMissionListByLocation(address, pageable));
    }
    ...
    public ApiResponse<MissionResDTO.MissionCompleteResult> completeMission(
        ...
        return ApiResponse.of(MissionSuccessCode.MISSION_CREATE_SUCCESS, null);
    }
